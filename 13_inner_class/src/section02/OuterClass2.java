...
public class OuterClass2 {
	...
	private static int outerStaticNum = 20; // 클래스 변수(static 붙음) 클래스명.변수명
	...
	public static class StaticInnerClass{
		...
		public void display() {
			...
			// -> static끼리는 호출하는데 문제 없음
			System.out.println("outerStaticNum : " + outerStaticNum);
			
			// 정적(static) 내부 클래스라도 내부의 non-static 멤버끼리는 호출 가능 
		...
		public static void staticDisplay() {
			...
			// 외부 클래스의 클래스 변수는 
			// 정적 내부 클래스의 static 메서드에서도 호출이 가능하다
			System.out.println("outerStaticNum : " + outerStaticNum);
