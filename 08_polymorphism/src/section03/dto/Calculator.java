 ...
 * 				(화면이 접점의 역할)
 * 
 * - 자바(객체 지향 프로그래밍)에서는 객체간의 접점을 만드는 용도로 사용
 * 
 * - 효과
 * 1) 클래스/객체 간의 접점을 만들 수 있다
 * 2) 극한의 추상화를 통해서 유연한 코딩이 가능하다
 * 3) 상속 받은 자식 클래스가 모두 같은 형태를 갖는다
 * 
 * 
 * [참고]
 * 대부분의 인터페이스를 상속받은 클래스는 
 * 인터페이스에서 제공하는 메서드만 오버라이딩하고 
 ...
 * 
 * - 인터페이스 사용법
 * 1) 해당 인터페이스를 상속 받을 클래스에 implements(구현하다) 키워드를 작성
...
public interface Calculator {
	...
	/* 기본적으로 추상 메서드만 작성 가능!
	 * -> 추상 메서드는 상속 받은 자식 클래스에서 오버라이딩이 강제됨
	 *  */
