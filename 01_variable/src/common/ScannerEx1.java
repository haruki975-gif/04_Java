...
public class ScannerEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("num1 + num2 = " + num1 + num2); 	 // 3 + 5 = 35
		System.out.println("num1 + num2 = " + (num1 + num2));  // 3 + 5 = 8
