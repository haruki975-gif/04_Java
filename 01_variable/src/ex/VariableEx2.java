...
public class VariableEx2 {
	...
	public static void main(String[] args) {
		...
		// [a1 + b1]
		// 1) int + double 연산 -> 값 처리 원칙 위배 (Type mismatch)
		...
		// 왜 결과가 1.5가 아니라 1?
		// - 값 처리 원칙에 의해서
		//   int / int의 결과는 무조건 int가 되어야 하기 때문에
		//   컴파일러가 1.5(double)을 1(int)로 자동 형변환
		//   -> 값의 범위와 관계없는 자동 형변환 예외 경우
		...
		System.out.println("result4 : " + result4); // 123 (정수 부분만)
