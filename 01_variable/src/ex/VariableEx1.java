...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		...
		// 변수 선언
		int num1;
		// 메모리에 int형 정수를 저장할 공간 "4byte"를 할당하고
		// 해당 공간(변수)의 이름을 num1이라고 지정
		// * int형 정수 : -21.47억 ~ +21.47억
		
		
		/* Java 지역변수는 초기화를 하지 않은 경우
		 * 출력, 연산을 할 수 없다.
		 * (단, 대입 연산은 제외)
		 */
		...
		// sysout -> ctrl + space -> enter : println() snippet(약어, 줄임말) 자동완성
		System.out.println("--------------------------");
		...
		// 2147483648L 또는 2147483648l 표기 == long으로 인식
		long longNum1 = 2147483648L;
		
		// 자릿수 구분을 위해 _ 사용 가능 -> 연산 시 인식 X
		 ...
		 * 	 기본적으로 크기가 정해져 있는 "기본 자료형"에 포함되지 않는다
		 * 
