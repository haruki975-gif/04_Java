...
public class ArrayService1 {
	...
	public void method1() {
		...
		// int[4] : int형 변수 4개가 묶인 배열 할당
		// -> Heap 메모리 영역은 빈칸으로 존재 불가!!!!!
		// -> JVM이 자료형별 기본값(0)으로 초기화함
	...
	/**
	 * 인원수를 입력 받아 그 크기를 가지는 정수 배열을 선언, 할당하고
	...
	public void method5() {
		...
		int maxIndex = 0; // 첫번째 index가 일단 최고/최저라고 기록
		int minIndex = 0;
		...
		for(int i=1; i<scoreArr.length; i++) {
			...
			if(scoreArr[i] < scoreArr[minIndex]) {
				minIndex = i; // 현재 인덱스 i를 maxIndex에 대입
