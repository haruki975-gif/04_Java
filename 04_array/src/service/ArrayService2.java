...
public class ArrayService2 {
	...
	public void method1() {
		...
		int[] copyArr2 = new int[arr2.length]; // new int[4]도 가능
		...
		// A : 원본 배열명
		// B : 원본 배열에서 복사를 시작할 인덱스 번호 (어디부터 복사?)
		// C : 복사된 배열 요소 값이 저장될 배열명 (어디로 복사?)
		// D : 복사하려는 배열에 값을 저장하기 시작할 인덱스 번호 (몇 번부터 집어넣는?)
