...
public class StreamTest {
	public static void main(String[] args) {
		...
		List<Integer> numbers = Arrays.asList(2,5,3,4,44,34);
		...
		.forEach(num -> System.out.printf(num + " "));
		...
		/* sorted() 
		 * - 객체에 정의된 기본 정렬 방법으로 정렬된 스트림 생성
		 * - (Comparable 인터페이스 상속 필요)
		 * */
		System.out.println();
		List<Integer> list = Arrays.asList(11,56,111,2,20,3);
