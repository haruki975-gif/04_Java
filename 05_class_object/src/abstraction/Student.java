...
public class Student {
	...
	public Student() {
		...
		// - heap 영억은 비어있는 상태로 존재 불가
		// - 정수형 : 0, 실수형 : 0.0, 
		//   논리형 : false, 문자형 : '\u0000', 
		//   참조형 : null ( 참조하는 객체가 없다, 저장된 주소가 없다)
		
		/* 생성자를 이용해서 객체가 생성될 때
		 * 실드 값을 원하는 값으로 초기화할 수 있다. */
	...
	// Duplicate method Student() in type Student : 이름 중복
	/* 매개 변수가 있는 생성자 */
	...
	// getter : 객체의 필드값을 얻어가게 만드는 메서드(가져가라)
